...
import { PhoneIcon, EmailIcon, LocationMarkerIcon } from './Icons';
            ...
            <div className="flex flex-col justify-center">
              <div className="space-y-8">
                <div className="rounded-lg overflow-hidden shadow-2xl border-2 border-brand-brown">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3557.558360434914!2d-49.07191168495521!3d-26.9177199831247!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94df18f3a34a40a5%3A0x8b305009a6ef062!2sR.%20das%20Palmeiras%2C%20123%20-%20Centro%2C%20Blumenau%20-%20SC%2C%2089010-020!5e0!3m2!1sen!2sbr!4v1689264123456"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                ...
                <div>
                  ...
                  <div className="flex items-start space-x-3 text-light-cream">
