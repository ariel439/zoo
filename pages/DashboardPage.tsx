...
import AnimalManagementPage from '../components/AnimalManagementPage';
import AnimalDetailsPage from '../components/AnimalDetailsPage';
import AnimalFormPage from '../components/AnimalFormPage';
import ConfirmationModal from '../components/ConfirmationModal';
import GenericManagementPage from '../components/GenericManagementPage';
import KeeperDetailsPage from '../components/KeeperDetailsPage';
import KeeperFormPage from '../components/KeeperFormPage';
import VetDetailsPage from '../components/VetDetailsPage';
import VetFormPage from '../components/VetFormPage';
import HabitatDetailsPage from '../components/HabitatDetailsPage';
...
const DashboardPage: React.FC<DashboardPageProps> = ({ setPage }) => {
    ...
    return (
        <div className="h-screen bg-dark-bg font-sans text-light-cream flex overflow-hidden">
